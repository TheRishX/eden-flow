  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer hidden md:flex flex-col text-sidebar-foreground h-full", // Use flex-col and h-full
          className,
        )}
        data-state={state}
...
>(({ className, onClick, tooltip, ...props }, ref) => {
  ...
  const button = (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn('h-8 w-8 hover:bg-white/10', className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side="right"
        align="center"
        className="bg-black/70 text-white border-white/10"
        {...tooltip}
      />
    </Tooltip>
  );
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        'flex h-12 items-center justify-center group-data-[state=expanded]:justify-end group-data-[state=expanded]:px-2',
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'group-data-[state=collapsed]:ml-2 group-data-[state=collapsed]:-mt-8 group-data-[state=collapsed]:opacity-0',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      'flex w-full min-w-0 flex-col gap-1 px-2 items-center group-data-[state=expanded]:items-stretch',
      className
    )}
    {...props}
  />
